...
class EasyListViewState extends State<EasyListView> {
  ...
  Widget _buildList() {
    ...
    if (widget.foregroundWidget != null && widget.itemCount == 0) children.add(widget.foregroundWidget);
  ...
  int _dataItemCount() => _hasDivider() && widget.itemCount > 0 ? widget.itemCount * 2 : widget.itemCount;
