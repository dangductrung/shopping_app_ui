...
class ProductThumb extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    ...
    return Container(margin: EdgeInsets.symmetric(horizontal: 10,vertical: 15),
      child: Stack(
        children:[
          Container(
            ...
            children: [
                Container(margin: EdgeInsets.only(top:10),
                  child:Image.asset("assets/imgs/meow.jpg"),width: 120, height: 120,),
                Expanded(
                  child: Container(padding: EdgeInsets.fromLTRB(10, 5, 0, 0),
                    child: Column(
                        children: [
          ...
          Container(alignment: Alignment.center,
            color: Colors.yellow, width: width*10,height: height*5,
